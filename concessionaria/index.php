        ...
        <div class="col-md-12">
          <div class="card text-white p-5 bg-primary" style="background-image: url('/concessionaria/img/thumb-1920-719872.jpg');background-size:cover;">
            <div class="card-body">
              ...
              <form method="post" action="/concessionaria/control/controleUsuario.php">
                <div class="form-group">
                  <label>Nome de Usuário</label>
                  <input type="text" class="form-control" placeholder="Digite seu nome" name="nome" id="nome"> </div>
                <div class="form-group">
                  <label>Senha</label>
                  <input type="password" name="senha" id="senha" class="form-control" placeholder="Digite sua senha"> </div>
                <button type="submit" name="opcao" value="Entrar" class="btn btn-secondary">Entrar</button>
                <a class="nav-link active text-light" href="/concessionaria/view/cadastro.php">Faça seu cadastro aqui.</a>
              </form>
            </div>
          </div>
        </div>
